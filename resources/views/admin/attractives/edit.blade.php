		...
		<div class="inside">
            ...
            <div class="row">
             ...
             <div class="row mtop16">
            	...
            	<div class="col-md-6">
            		<label for="category">Categoría - Municipio:</label>
            		<div class="input-group">
            			
            			<span class="input-group-text" id="basic-addon1"><i class="fas fa-font"></i>
            			</span>

            		 {!! Form::select('category', $cats, $at->category_id, ['class' =>'form-select', 'id' => 'category']) !!}
                         {!! Form::hidden('subcategory_actual', $at->subcategory_id, ['id' => 'subcategory_actual']) !!}
                  ...
                  <div class="col-md-6">
                        <label for="category">Subcategoría -  Lugar:</label>
                        <div class="input-group">
