<div class="sidebar shadow">
	...
	<div class="main">
		<ul>
			...
			<li>
				<a href="{{ url('/admin/attractives/1') }}" class="lk-attractives lk-attractives_add lk-attractives_search lk-attractive_edit lk-attractive_gallery_add "><i class="fas fa-cloud-sun-rain"></i>    Atractivos</a>
			</li>
			@endif
